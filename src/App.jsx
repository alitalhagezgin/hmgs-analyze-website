...
import { Scale, RotateCcw, BarChart2, AlertTriangle, X } from 'lucide-react';
...
export default function App() {
  ...
  }, [activeQuestion, questions, autoScroll, setQuestionStatus, scrollToQuestion]);
      ...
      <header className="bg-indigo-700 dark:bg-indigo-900 text-white shadow-lg transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-indigo-300 text-xs">Hukuk Mesleklerine Geçiş Sınavı — Analiz</p>
          </div>
      ...
      <footer className="sticky bottom-0 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 shadow-[0_-2px_12px_rgba(0,0,0,0.06)] transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          <span className="text-sm text-slate-500 dark:text-slate-400 font-medium">
            ...
            {!allAnswered && (
              <span className="text-orange-500 ml-1">· {TOTAL_QUESTIONS - answeredCount} eksik</span>
            )}
          </span>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 max-w-sm w-full transition-colors">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  <strong>{TOTAL_QUESTIONS - answeredCount} soru</strong> henüz işaretlenmedi.
                  Analizi yine de görmek ister misiniz?
                </p>
              </div>
              <button
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => { setShowIncompleteWarning(false); setShowAnalysis(true); }}
